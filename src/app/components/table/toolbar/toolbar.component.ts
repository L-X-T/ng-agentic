...
@Component({
  ...
  // Legacy zone-dependent component: pinned to the pre-v22 default, as `ng update` leaves
  // migrated code - the refactoring exercise (07-REFACTORING.md) moves it to OnPush.
